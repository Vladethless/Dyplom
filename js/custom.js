...
(function (jQuery) {
   ...
   jQuery(window).on('load', function (e) {
      ...
      jQuery(".pq-applyform .form-btn").click(function () {
         ...
         var Процедура = jQuery('#Процедура').val();
         ...
         if (Процедура == '' || Процедура == undefined) {
            jQuery("<span class='pq-Процедура-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-applyform .Процедура-field');
            result = false;
         }
         else {
            jQuery('.pq-Процедура-error-message').remove();
            result = true;
         }
