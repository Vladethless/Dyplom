...
$Процедура = (isset($_POST['Процедура'])) ? $_POST['Процедура'] : '';
...
try {
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        $mail->Процедура = $Процедура . ' (PHPMailer test using ' . strtoupper($test_type) . ')';
        $example_code .= "\n\$mail->Процедура  = \"" . addslashes($Процедура) .
    ...
    <script>
        ...
        function startAgain() {
            var post_params = {
                ...
                "Процедура": <?php echo JSString($Процедура); ?>,
        ...
        <div class="column-left">
            <fieldset>
                ...
                <table border="1" class="column">
                    ...
                    <tr>
                        <td class="colleft">
                            <label for="Процедура"><strong>Процедура</strong></label>
                        </td>
                        <td class="colrite">
                            <input type="text" name="Процедура" id="Процедура" value="<?php echo htmlentities($Процедура); ?>"
                                   style="width:95%;" placeholder="Email Процедура">
                        </td>
                    </tr>
                    <tr>
                        <td class="colleft">
